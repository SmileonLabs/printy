...
import { AppButton, Screen, SoftCard } from "@/components/ui";
import { PrintyBrandLogo } from "@/components/ui/logo";
import { orderHighlights } from "@/lib/mock-data";
      ...
      <div className="flex min-h-full flex-col justify-between pb-5">
        <div>
          ...
          <section className="animate-float-in">
            ...
            <h1 className="text-4xl font-black leading-tight tracking-[-0.0em] text-ink">내 브랜드를 오늘 바로</h1>
            <h1 className="text-4xl font-black leading-tight tracking-[-0.0em] text-ink">인쇄물로 만들어요</h1>
